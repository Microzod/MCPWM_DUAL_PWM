#ifndef _MCPWM_DUAL_PWM_H_
#define _MCPWM_DUAL_PWM_H_
...
class MCPWM_DUAL_PWM
{
	
public:
	MCPWM_DUAL_PWM(int pwmPinA = 17, int pwmPinB = 18, uint32_t pwm_freq = 21000, uint8_t pwm_resolution = 10);
