...
void MCPWM_DUAL_PWM::initPWM(int startAtDutyCycle)
{
    ...
    //attachInterruptArg(digitalPinToInterrupt(_enc_pin_A), MCPWM_DUAL_PWM::_onEncA, (void*)this, RISING);
    //attachInterruptArg(digitalPinToInterrupt(_enc_pin_B), MCPWM_DUAL_PWM::_onEncB, (void*)this, RISING);
